...
- Separate observation, interpretation, hypothesis, recommendation, and approved action.
- Protect sensitive or identifiable data and prefer the minimum necessary detail.
- Preserve reproducible queries or methods when appropriate, but never commit credentials or private extracts without authorization.
